...
"В обеих задачах я использовал forEach. В 3-ей задаче используется NodeList с размером в 7 элементов, а в 5-ой задаче NodeList имеет 4 элемента. В 3-ем задании при выполнении события поиск и перебор будет больше на 3 элемента чем в 5-ом задании. Я считаю что из-за этой разницы результат 5-ой задачи пишется раньше чем результат 3-ей. "
